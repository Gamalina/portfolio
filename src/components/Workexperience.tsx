...
import { FaBriefcase, FaGraduationCap, FaCertificate, FaEnvelope, FaPhone, FaLinkedin } from 'react-icons/fa'
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-2/3">
            ...
            >
              ...
              <FaEnvelope className="text-yellow-500 mr-2" />Contact Information</h3>
              <p className="text-gray-400 text-center mb-4">Feel free to reach out to me through any of these platforms. I&apos;m always open to new opportunities and collaborations!</p>
              <div className="space-y-4">
                <div className="flex items-center justify-center">
                  <FaEnvelope className="text-yellow-500 mr-2" />
                  <a href={`mailto:${contactInfo.email}`} className="text-gray-300 hover:text-yellow-500 transition-colors">
                    {contactInfo.email}
                  </a>
                </div>
                <div className="flex items-center justify-center">
                  <FaPhone className="text-yellow-500 mr-2" />
                  <a href={`tel:${contactInfo.phone}`} className="text-gray-300 hover:text-yellow-500 transition-colors">
                    {contactInfo.phone}
                  </a>
                </div>
                <div className="flex items-center justify-center">
                  <FaLinkedin className="text-yellow-500 mr-2" />
                  <a href={contactInfo.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-yellow-500 transition-colors">
                    LinkedIn
                  </a>
                </div>
              </div>
