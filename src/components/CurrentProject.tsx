    ...
    <section id="current-project" className="py-20 bg-gray-800" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        <div className="md:flex md:justify-between md:items-start">
          ...
          >
            <p className="text-lg leading-relaxed">
              ...
              <span className="text-yellow-500">full-stack</span> eCommerce
              store with an admin panel, using Next.js, React, MongoDB, and
              TailwindCSS for styling.
            </p>
            <p className="text-lg leading-relaxed">
              The <span className="text-yellow-500">admin panel</span> features
              a dashboard to track orders and revenue, alongside product and
              category <span className="text-yellow-500">management</span> (add,
              edit, view, delete). The order page allows you to view and mark
              orders as shipped.
            </p>
            <p className="text-lg leading-relaxed">
              On the <span className="text-yellow-500">front-end</span>, users
              can explore featured products, add items to the cart,{" "}
              <span className="text-yellow-500">filter</span> by category, and
              manage their orders and watchlist on the account page. The cart
              page includes a checkout function with{" "}
          ...
          <motion.div
            ...
            className="md:w-1/3 sm:grid-cols-2 flex flex-col items-end space-y-4"
          >
            <ProjectLink
        ...
        <motion.div
          ...
          className="mt-12 grid grid-cols-2 md:grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6"
        >
